      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">My Orders</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Your orders list will be here.</p>
                </div>
                <div class="container">
                     <a class="btn btn-primary me-3" href="order2.php" role="button">New Order</a>
                </div>
                <div class="card-body">
                      ...
                      <tbody>
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary me-3" href="edit_orders.php?idtrx=<?php echo $row['idtrx']; ?>" role="button">Edit</a>
                                        <a class="btn btn-danger" href="delete_order.php?idtrx=<?php echo $row['idtrx'];?>" role="button">Cancel</a>
                                    </td>
                                </tr>
                            <?php } ?>  
                      </tbody>
