<?php
    ...
    $sql = "SELECT * from orders WHERE idtrx = '$idtrx' ";
...
<head>
  ...
  <title>Mauverse Shop - Edit Orders</title>
  <!-- Favicon-->
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Let's orders the merch!</p>
                </div>
                  <div class="card-body">
                  <?php while ($ROW = mysqli_fetch_assoc($result)) : ?>
                    <form action="action_edit_orders.php" method="POST" enctype="multipart/form-data">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="bmd-label-floating">ID Transaction: </label>
                            <input type="hidden" class="form-control" name="idtrx" id="idtrx" value="<?php echo $ROW['idtrx']?>">
                            <input type="text" class="form-control" name="idtrx" id="idtrx" value="<?php echo $ROW['idtrx']?>" disabled>
                          </div>
                        </div>  
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="bmd-label-floating">Product: </label>
                            <input type="text" class="form-control" name="product" id="product" value="<?php echo $ROW['product']?>">
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
