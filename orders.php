...
<html lang="en">
    <head>
        ...
        <div class="container3"> 
            <div class="section-title">Shipping Order</div>  
            <div class="mb-3">
                 <label for="idtrx" class="form-label">ID Trx: </label>
                 <div class="col-sm-6">
                    <input type="text" name="idtrx" id="idtrx" class="form-control">
                </div>
            </div>              
            <div class="mb-3">
            ...
            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                <div class="text-left"><a class="btn btn-outline-dark mt-auto" href="action_orders.php">BUY</a></div>
            </div>
        </form>
    </div>
        <!-- Footer-->
