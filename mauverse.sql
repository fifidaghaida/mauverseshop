...
-- Dumping structure for table mauverse.agenda
...
-- Dumping data for table mauverse.agenda: ~0 rows (approximately)
DELETE FROM `agenda`;
...
-- Dumping structure for table mauverse.berita
...
-- Dumping data for table mauverse.berita: ~11 rows (approximately)
DELETE FROM `berita`;
...
-- Dumping structure for table mauverse.download
...
-- Dumping data for table mauverse.download: ~3 rows (approximately)
...
-- Dumping structure for table mauverse.galeri
...
-- Dumping data for table mauverse.galeri: ~0 rows (approximately)
DELETE FROM `galeri`;
...
INSERT INTO `galeri` (`id_galeri`, `id_kategori_galeri`, `id_user`, `bahasa`, `judul_galeri`, `jenis_galeri`, `isi`, `gambar`, `website`, `hits`, `popup_status`, `urutan`, `status_text`, `tanggal`) VALUES
	(15, 4, 4, 'ID', 'Java Web Media', 'Homepage', NULL, 'banner-3-1-1600727828.jpg', 'https://javawebmedia.com/kursus', NULL, 'Publish', NULL, 'Ya', '2020-09-22 05:38:56');
/*!40000 ALTER TABLE `galeri` ENABLE KEYS */;


-- Dumping structure for table mauverse.heading
...
-- Dumping data for table mauverse.heading: ~6 rows (approximately)
DELETE FROM `heading`;
...
-- Dumping structure for table mauverse.kategori
...
-- Dumping data for table mauverse.kategori: ~2 rows (approximately)
...
-- Dumping structure for table mauverse.kategori_agenda
...
-- Dumping data for table mauverse.kategori_agenda: ~2 rows (approximately)
...
-- Dumping structure for table mauverse.kategori_download
...
-- Dumping data for table mauverse.kategori_download: ~4 rows (approximately)
...
-- Dumping structure for table mauverse.kategori_galeri
...
-- Dumping data for table mauverse.kategori_galeri: ~2 rows (approximately)
...
-- Dumping structure for table mauverse.kategori_staff
...
-- Dumping data for table mauverse.kategori_staff: ~2 rows (approximately)
...
-- Dumping structure for table mauverse.konfigurasi
...
-- Dumping data for table mauverse.konfigurasi: 1 rows
...
-- Dumping data for table mauverse.login: ~4 rows (approximately)
DELETE FROM `login`;
...
-- Dumping structure for table mauverse.migrations
...
-- Dumping data for table mauverse.migrations: ~0 rows (approximately)
...
-- Dumping data for table mauverse.orders: ~0 rows (approximately)
DELETE FROM `orders`;
...
-- Dumping structure for table mauverse.rekening
...
-- Dumping data for table mauverse.rekening: ~4 rows (approximately)
...
-- Dumping structure for table mauverse.staff
...
-- Dumping data for table mauverse.staff: ~8 rows (approximately)
DELETE FROM `staff`;
...
INSERT INTO `staff` (`id_staff`, `id_user`, `id_kategori_staff`, `slug_staff`, `nama_staff`, `jabatan`, `pendidikan`, `expertise`, `email`, `telepon`, `isi`, `gambar`, `status_staff`, `keywords`, `urutan`, `tanggal`) VALUES
	(1, 4, 4, 'basja-jantowski-program-director', 'Bina Rika', 'Program Director', NULL, NULL, NULL, NULL, NULL, 'board-and-team-01-1599999423a.png', 'Ya', NULL, 1, '2020-09-13 19:17:03'),
	(2, 4, 4, 'gracia-plenita-agnindhira-knowledge-and-learning-officer', 'Karyani', 'Knowledge and Learning Officer', NULL, NULL, NULL, NULL, NULL, 'board-and-team-05-15a99999506.png', 'Ya', NULL, 2, '2020-09-13 19:18:27'),
	(3, 4, 4, 'uli-fitri-handayani-communication-and-project-officer', 'Ulindi', 'Communication and Project Officer', NULL, NULL, NULL, NULL, NULL, 'board-and-team-09-1599999886.png', 'Ya', NULL, 3, '2020-09-13 19:25:05'),
	(4, 4, 6, 'heru-hendrayana-ketua-dewan-pembina', 'Uda', 'Ketua Dewan Pembina', NULL, NULL, NULL, NULL, NULL, 'board-and-team-07-1599a999946.png', 'Ya', NULL, 0, '2020-09-13 19:25:47'),
	(5, 4, 6, 'gita-syahrani-ketua-dewan-pengawas', 'Diana Widya', 'Ketua Dewan Pengawas', NULL, NULL, NULL, NULL, NULL, 'board-and-team-04-1599a999987.png', 'Ya', NULL, 2, '2020-09-13 19:26:28'),
	(6, 4, 6, 'fany-wedhahuditama-ketua-dewan-pengurus', 'Andoyo', 'Ketua Dewan Pengurus', NULL, NULL, NULL, NULL, NULL, 'board-and-team-06-160000a0085.png', 'Ya', NULL, 3, '2020-09-13 19:28:14'),
	(7, 4, 6, 'fainta-susilo-negoro-sekretaris-dewan-pengurus', 'Muhammad Soleh', 'Sekretaris Dewan Pengurus', NULL, NULL, NULL, NULL, NULL, 'board-anad-team-03-1600000132.png', 'Ya', NULL, 4, '2020-09-13 19:29:04'),
	(8, 4, 6, 'chrisandini-bendahara-dewan-pengurus', 'Dani Widya', 'Bendahara Dewan Pengurus', NULL, NULL, NULL, NULL, NULL, 'board-and-team-02-160000a0191.png', 'Ya', NULL, 5, '2020-09-13 19:30:13');
...
-- Dumping structure for table mauverse.users
...
-- Dumping data for table mauverse.users: ~2 rows (approximately)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id_user`, `nama`, `email`, `username`, `password`, `akses_level`, `kode_rahasia`, `gambar`, `tanggal`) VALUES
	(4, 'Andoyo Cakep', 'javawebmedia@gmail.com', 'javawebmedia', 'dc28d4424ece38803650f440d7eb1cb2b3fb6651', 'Admin', NULL, 'testimonials-1.jpg', '2020-09-22 05:07:43'),
...
-- Dumping structure for table mauverse.video
...
-- Dumping data for table mauverse.video: ~0 rows (approximately)
DELETE FROM `video`;
/*!40000 ALTER TABLE `video` DISABLE KEYS */;
INSERT INTO `video` (`id_video`, `judul`, `posisi`, `keterangan`, `video`, `urutan`, `bahasa`, `gambar`, `id_user`, `tanggal`) VALUES
	(66, 'Sesi 2a Penggunaan Mendeley (Praktek dan Langkah-langkah Pengerjaannya)', 'Homepage', 'Sesi 2a Penggunaan Mendeley (Praktek dan Langkah-langkah Pengerjaannya)', 'vsb93FnDim0', 1, 'Indonesia', 'post-fb-2-1600728513.png', 4, '2020-09-22 05:48:33');
